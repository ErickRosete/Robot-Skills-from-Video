...
def discretized_mix_logistic_loss(y_hat, y, nr_mix=10, num_classes=256,
...
def sample_from_discretized_mix_logistic(y, nr_mix=10, log_scale_min=-7.0,
...
if __name__ == '__main__':
    ...
    loss = discretized_mix_logistic_loss(prediction, target, num_classes=256, log_scale_min=-7.0)
    print(loss.shape)
