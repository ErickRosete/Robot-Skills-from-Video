...
def discretized_mix_logistic_loss(y_hat, y, num_classes=256, nr_mix=10,
...
if __name__ == '__main__':
    ...
    y_hat = torch.rand(BATCH_SIZE, 3 * N_MIX, N_DOF_ROBOT)#.cuda()
    y = torch.rand(BATCH_SIZE, N_DOF_ROBOT, 1)#.cuda()
    loss = discretized_mix_logistic_loss(y_hat, y, num_classes=256, log_scale_min=-7.0)
    print(loss)
